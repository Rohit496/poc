...
describe('AddExpenseComponent', () => {
  ...
  beforeEach(async () => {
    expenseServiceSpy = { addExpense: jest.fn().mockReturnValue(MOCK_EXPENSE) } as unknown as jest.Mocked<ExpenseService>;
  ...
  it('should be valid with amount, date, and category filled', () => {
    component.form.setValue({ amount: 10, date: '2026-04-29', category: 'Food', description: '' });
  ...
  it('should call ExpenseService.addExpense() on valid submit', () => {
    component.form.setValue({ amount: 10, date: '2026-04-29', category: 'Food', description: 'test' });
    component.onSubmit();
