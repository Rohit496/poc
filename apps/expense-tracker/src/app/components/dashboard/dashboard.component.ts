...
import { Expense, ExpenseCategory, CategorySlice, CategoryView } from '../../models/expense.model';
import {
  EXPENSE_CATEGORIES,
...
@Component({
  ...
  standalone: true,
  imports: [AsyncPipe, DecimalPipe, NgFor, RouterLink, DeleteConfirmDialogComponent, DonutChartComponent],
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    const saved = this.storageService.get<CategoryView>(CATEGORY_VIEW_STORAGE_KEY);
